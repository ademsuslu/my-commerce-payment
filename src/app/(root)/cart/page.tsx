...
const items =basket[0].basketItems
  ...
  return (
   <div className="flex flex-col container mx-auto">
     ...
     {
       items.map(product =>{
         return  <div key={product.id} className="border  flex flex-row justify-between hover:shadow-md">
         <div className="flex ">
         ...
         <div>
           <Button className="" variant={"default"}>Arttır</Button>
           <span className="p-3">{product.quantity}</span>
           <Button className="" variant={"default"}>Azalt</Button>
         </div>
       </div> 
       }
      )}
